                ...
                while ($result_coin = $coin_info->fetch(PDO::FETCH_LAZY)) {
                    ...
                    if (!$difficulty) {
                        ...
                        if ($algo == 'Ethash' || $coin_code == 'ANON' || $algo == 'Cryptonight_v7' || $coin_code == 'HUSH' || $algo == 'CryptoNight_Heavy' || $algo == 'Equihash_210_9') {
                            ...
                            $qty = ($my_hashrate * $block_reward * $DAY * $interval_profit) / ($difficulty * 65536);
                        } elseif ($algo == 'Equihash_192_7') {
                            $qty = ($my_hashrate * $block_reward * $DAY * $interval_profit) / ($difficulty * 22);
                        } else {
